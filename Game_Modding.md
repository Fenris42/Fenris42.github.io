...
- Assumptions made:
	...
	- The [Isotropic Centrifuge](https://wiki.aidancbrady.com/wiki/Isotopic_Centrifuge){:target="_blank"} only has 1 output slot so the other material separated just disappears or can be assumed that the end product is refined but not pure.
...
- Unable to convert (BER) [Cyanite Ingot](https://ftbwiki.org/Cyanite_Ingot){:target="_blank"} to (Mek) [Nuclear Waste](https://wiki.aidancbrady.com/wiki/Nuclear_Waste){:target="_blank"} as [Nuclear Waste](https://wiki.aidancbrady.com/wiki/Nuclear_Waste){:target="_blank"} to [Plutonium Gas](https://wiki.aidancbrady.com/wiki/Plutonium){:target="_blank"} in a [Isotropic Centrifuge] is a taken recipe and must find an alternate route that does not involve the [Solar Neutron Activator](https://wiki.aidancbrady.com/wiki/Solar_Neutron_Activator){:target="_blank"}.
